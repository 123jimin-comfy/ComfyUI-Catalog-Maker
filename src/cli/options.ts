...
export function parseOptions(args: string[]): CommandOptions {
    ...
    parser.add_argument('--png-quality', {"default": null, "metavar": 'MIN-MAX', "help": 'pngquant quality range (default: 65-80).'});
    ...
    const match = /^(\d{1,3})-(\d{1,3})$/.exec(parsed.png_quality ?? '65-80');
